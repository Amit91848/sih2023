from prakat.models import Model
...
class LocalModel(Model):
    ...
    def inference(self, query: str,  sys_prompt: str, temp: float=0.6, rep_penalty: float=1.1, max_tokens: int=128, top_k: int=30) -> str:
        prompt = f"<SYS>{sys_prompt}</SYS>Q: {query}\nA: "
